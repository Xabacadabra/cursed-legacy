...
Paul estrae la bomba dal corpo di Vibeke (che verrà qualche modo ricucita) quindi riesce a posarla delicatamente a terra valutando se è il caso di arrischiarsi a disinnescarla... 

la cosa generi un breve (ennesimo) conflitto interno:
...
Grazie all'intervento della setita, Thomas e Alice scampano anche ad un agguato di alcuni sicari intenzionati a ripulirli della "vincita" (sicari che, come poi ammetterà lei stessa, risultano alle dipendenze di Ranya).
...
Thomas deve impegnarsi a concedere, tramite un contratto riconosciuto dalla Camarilla di San Francisco, piena libertà d'azione al Clan Setita nella città californiana secondo gli standard garantiti dal Principe Vannevar (in pratica una sorta di enclave, sul modello dell'Elixir Club degli anarchici).
...
Thomas coglie l'occasione per telefonare il suo contatto Charles, chiedendogli planimetrie dei casinò Tropicana e Flamingo.
